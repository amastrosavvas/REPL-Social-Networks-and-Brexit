...
* The R scripts numbered 1-8 perform all preceeding data processing steps:
  * `1a_get_lookups.R` produces lookups to harmonised spatial classifications, and product-industry lookups.
  ...
  * `6b_calc_lagged_import_shocks.R` produces measures of exposure to import competition in regions' social / spatial neighbours.
