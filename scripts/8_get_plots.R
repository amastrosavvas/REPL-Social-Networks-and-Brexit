...
colfunc <- colorRampPalette(c("#800000", "#ffffff")) # Palette  
...
ggplot() +
  ...
  theme(
    strip.text.y = element_text(size = 10, color = "black", margin = margin(0, 0, 0, 0.35, "cm")),
